  ...
  return (
    ...
    >
      <div className="sidebar-header flex items-center p-2">
        <Link to="/papertrade/app" className="inline-flex flex-row items-center">
