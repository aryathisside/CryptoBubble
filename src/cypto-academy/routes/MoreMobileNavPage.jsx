...
const MoreMobileNavPage = () => {
  ...
  return (
    <>
      <Link to="/papertrade/app/profile" className="px-4 mt-3 flex justify-between items-center ">
      ...
      <div className="shadow-lg rounded-2xl bg-gray-900 py-6 mx-4 mt-4 space-y-4">
        <Link to="/papertrade/app/news" className="px-4  flex justify-between items-center">
        ...
        <Link to="/papertrade/app/watchlist" className="px-4  flex justify-between items-center">
          <div className="flex justify-center space-x-2 items-center cursor-pointer">
        ...
        <Link to="/papertrade/app/leaderboard" className="px-4  flex justify-between items-center">
          <div className="flex justify-center space-x-2 items-center cursor-pointer">
        ...
        <Link to="/papertrade/app/market/globalStats" className="px-4  flex justify-between items-center">
          <div className="flex justify-center space-x-2 items-center cursor-pointer">
        ...
        <Link to="/papertrade/app/learn" className="px-4  flex justify-between items-center">
          <div className="flex justify-center space-x-2 items-center cursor-pointer">
      ...
      <div className="shadow-lg rounded-2xl bg-gray-900 py-6 mx-4 mt-2 space-y-4">
        ...
        <Link to="/papertrade/app/faq" className="px-4  flex justify-between items-center">
          <div className="flex justify-center space-x-2 items-center cursor-pointer">
