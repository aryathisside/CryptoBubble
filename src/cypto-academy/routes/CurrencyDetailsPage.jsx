...
const CurrencyDetailsPage = () => {
  ...
  return (
    <section className="lg:px-8 p-3">
      ...
      <div className=" max-w-[1050px] bg-[#171A24]  px-4 rounded-[12px] m-3">
        {isSuccess && (
          <div className="mt-6">
            {/* back button */}
            <Link
            ...
            <div className="flex  md:space-x-8 justify-between pb-6 gap-8">
              {/* coin data */}
              ...
              <div className="flex-1">
                ...
                <div className="text-[#A9A9A9] text-sm border-b-4 border-[#CFA935] pb-3 flex gap-2 items-center"><BsArrowDownUp/> All Time High/Low Price</div>
        ...
        {isSuccess && (
          <div className="no-scrollbar flex flex-wrap md:gap-8 gap-3 justify-between rounded-box w-screen w-full overflow-auto max-w-full pt-8">
            ...
            <div className="md:w-full md:flex-1 w-[47%] p-2  bg-[#080808]  overflow-hidden shadow rounded-lg">
              ...
              <div  className={`font-text mt-1 leading-9 font-semibold pl-2 text-left text-xl font-bold ${
                        data?.market_data.price_change_percentage_24h >= 0 ? 'text-green-400' : 'text-red-400'
                      } `}>
                      {data?.market_data.price_change_percentage_24h >= 0 && '+'}
                      {data.market_data.price_change_percentage_24h.toFixed(3)}%</div>
            </div>
            <div className="md:w-full md:flex-1 w-[47%] p-2  bg-[#080808]  overflow-hidden shadow rounded-lg">
              <div className="flex items-center p-2 gap-3">
              ...
              <div className="font-text mt-1 text-xl pl-2 leading-9 font-semibold text-white"> {normalizeMarketCap(data.market_data.total_volume.usd)}</div>
            </div>
      ...
      <div className="flex-[1] m-3 hidden md:block">
            ...
            {isSuccess && <CoinDetail data={data} />}
    </section>
  );
};
